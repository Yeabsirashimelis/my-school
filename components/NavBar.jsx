...
function NavBar() {
  ...
  return (
    <nav className="bg-gray-50  text-red-800 w-full z-10">
      <div className="container mx-auto px-4 md:px-8 flex text-center   justify-between h-16">
        {/* Logo */}
        ...
        <div className="hidden lg:flex space-x-6 pt-4">
          <Link href="/">
            <p
              className="relative  before:absolute before:left-0 before:bottom-0 
            hover:before:w-full before:h-1 before:bg-red-800 before:content-['']
             hover:before:animate-underline transition-all duration-300"
            >
              Home
            </p>
          </Link>
        ...
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/" onClick={closeMenu}>
              ...
              hover:bg-red-800 hover:text-gray-100 hover:scale-105 px-4 py-1 
              transition-full duration-500 font-medium"
              >
                Home
              </p>
            </Link>
