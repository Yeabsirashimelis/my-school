...
function EachAchiever({ achiever, removeAchiever }) {
  ...
  return (
    <div className="bg-gray-50 shadow-lg rounded-lg overflow-hidden border-t-4 border-red-600">
      <div className="p-6 flex flex-col items-center">
        <Image
          ...
          width={150}
          height={150}
          className="rounded-full ring-4 ring-red-600"
        />
        <h2 className="mt-4 text-xl font-semibold text-black">{name}</h2>
        <h3 className="mt-2 text-lg text-red-600 font-bold">Score: {score}</h3>
